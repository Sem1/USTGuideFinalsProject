...
public class Course21 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course21);
        ...
        courses.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Course21.this, Courses.class));
                finish();
            }
        });
        ...
        map.setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                startActivity(new Intent(Course21.this, Map.class));
                finish();
            }
        });
